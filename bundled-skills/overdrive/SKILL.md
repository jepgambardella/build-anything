---
name: overdrive
description: Push interfaces past conventional limits with technically ambitious implementations.
  Whether that's a shader, a 60fps virtual table, spring physics on a dialog, or scroll-driven
  reveals — make users ask "how did they do that?"
metadata:
  source_user-invocable: true
  source_argument-hint:
  - TARGET=<value>
---
